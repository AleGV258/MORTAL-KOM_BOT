...
SoundFile background, collision, die, drop, jump; //Variables del sonido
//int x, y, xn, yn; //Variables de escalado
...
float velocidadDron = 8; ////Velocidad del Dron
...
void setup(){
  ...
  background = new SoundFile(this, "Background.mp3"); //Cargar el sonido de fondo
  jump = new SoundFile(this, "Jump.mp3"); //Sonido de disparo del Androide
  drop = new SoundFile(this, "Drop.mp3"); //Sonido de disparo del Dron
  die = new SoundFile(this, "Die.mp3"); //Sonido de muerte del Androide o del Dron
  collision = new SoundFile(this, "Collision.mp3"); //Sonido de la colisión de cualquier proyectil
  background.loop(); //Reproducir la música de fondo
}
...
void mousePressed() {
  ...
  if(mouseX < 440 + 400 && mouseX > 440 && mouseY > 460 && mouseY < 460 + 150 && vidaDron == 0 || vidaAndroide == 0){
    //configuración Androide
    vida1 = "";
    vidaAndroide = 3; //Vidas del Androide
    contadorAndroide = 0; //Contador para renderizar frames del Androide
    velocidadAndroide = 5; //Velocidad del Androide
    
    //configuración Dron
    vida2 = "";
    velocidadDron = 8; //Velocidad del Dron
    vidaDron = 5; //Vidas del Dron
